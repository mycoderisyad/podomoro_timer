...
class DataSettingsSection extends StatelessWidget {
  ...
  const DataSettingsSection({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        SettingsSectionTitle(title: l10n.data),
            ...
            children: [
              ...
              DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  value: controller.autoClearSchedule,
                  isExpanded: true,
                  ...
                  items: SettingsFormController.autoClearOptions
                      .map((value) {
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      controller.setAutoClearSchedule(value);
                    }
                  },
                ),
              ),
