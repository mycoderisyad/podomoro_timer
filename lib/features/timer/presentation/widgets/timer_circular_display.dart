...
import 'package:podomoro_timer/features/timer/presentation/widgets/timer_display.dart';
...
class TimerCircularDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalDuration = currentMode.isFocus ? focusDuration : breakDuration;
    final progress = 1 - (secondsRemaining / totalDuration);
    final modeLabel =
        modeLabelOverride ??
        (currentMode.isFocus ? l10n.focus : l10n.breakLabel);
            ...
            children: [
              ...
              Container(
                ...
                child: ConstrainedBox(
                  constraints: BoxConstraints(maxWidth: timerSize * 0.6),
                  child: Text(
                    sessionLabel,
                    maxLines: 1,
